...
api_key = os.getenv("API_KEY")   # Change "API_KEY" to the variable name you chose in .env

# Now use api_key in your code wherever needed, for authenticating API calls etc.
